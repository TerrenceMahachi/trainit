const displayColumns = [
    ...
    { key: 'user', label: 'user' },
    { key: 'clientmemberrole', label: 'clientmemberrole' },
];
...
function loadData() {
    ...
    var n_clientmemberrole = $('.search').find('[name=clientmemberrole]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-clientmembership-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            user: n_user,
            clientmemberrole: n_clientmemberrole
        },
