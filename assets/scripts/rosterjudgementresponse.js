const displayColumns = [
    ...
    { key: 'motivation_narrative', label: 'motivation narrative' },
    { key: 'primary_function_evidence', label: 'primary function evidence' },
    { key: 'shared_client_management_plan', label: 'shared client management plan' },
    { key: 'error_discovery_resolution', label: 'error discovery resolution' },
    { key: 'urgent_friday_deadline_dilemma', label: 'urgent friday deadline dilemma' },
    { key: 'associate_apprentice_qa_methodology', label: 'associate apprentice qa methodology' },
    { key: 'associate_unethical_client_solution', label: 'associate unethical client solution' },
    { key: 'apprentice_twelve_month_goal', label: 'apprentice twelve month goal' },
...
function loadData() {
    ...
    var uri = site + "/get-rosterjudgementresponse-records";
