const displayColumns = [
    ...
    { key: 'national_id_doc', label: 'national id doc' },
    ...
    { key: 'bank_currency', label: 'bank currency' },
    ...
    { key: 'police_clearance_doc', label: 'police clearance doc' },
    { key: 'police_clearance_date', label: 'police clearance date' },
    { key: 'signed_contract_doc', label: 'signed contract doc' },
    { key: 'signed_nda_doc', label: 'signed nda doc' },
    { key: 'odoo_applicant_id', label: 'odoo applicant id' },
    { key: 'odoo_employee_id', label: 'odoo employee id' },
    { key: 'synced_to_odoo_at', label: 'synced to odoo at' },
];
...
function loadData() {
    ...
    var uri = site + "/get-rosteronboarding-records";
