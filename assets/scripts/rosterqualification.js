const displayColumns = [
    ...
    { key: 'qualificationtype', label: 'qualificationtype' },
    { key: 'professionalbody', label: 'professionalbody' },
    { key: 'qualificationstatus', label: 'qualificationstatus' },
    { key: 'title', label: 'title' },
    { key: 'institution_name', label: 'institution name' },
    { key: 'field_of_study', label: 'field of study' },
    { key: 'date_obtained', label: 'date obtained' },
    { key: 'expiry_date', label: 'expiry date' },
    { key: 'certificate_doc', label: 'certificate doc' },
];
...
function loadData() {
    ...
    var n_qualificationtype = $('.search').find('[name=qualificationtype]').val();
    var n_professionalbody = $('.search').find('[name=professionalbody]').val();
    var n_qualificationstatus = $('.search').find('[name=qualificationstatus]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-rosterqualification-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            qualificationtype: n_qualificationtype,
            professionalbody: n_professionalbody,
            qualificationstatus: n_qualificationstatus
        },
