const displayColumns = [
    ...
    { key: 'refereecontacttiming', label: 'refereecontacttiming' },
    { key: 'refereeverificationstatus', label: 'refereeverificationstatus' },
...
function loadData() {
    ...
    var n_refereecontacttiming = $('.search').find('[name=refereecontacttiming]').val();
    var n_refereeverificationstatus = $('.search').find('[name=refereeverificationstatus]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-rosterreferee-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            refereecontacttiming: n_refereecontacttiming,
            refereeverificationstatus: n_refereeverificationstatus
        },
