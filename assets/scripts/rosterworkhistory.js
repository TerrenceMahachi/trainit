const displayColumns = [
    ...
    { key: 'sectortype', label: 'sectortype' },
    { key: 'engagementbasis', label: 'engagementbasis' },
...
function loadData() {
    ...
    var n_sectortype = $('.search').find('[name=sectortype]').val();
    var n_engagementbasis = $('.search').find('[name=engagementbasis]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-rosterworkhistory-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            sectortype: n_sectortype,
            engagementbasis: n_engagementbasis
        },
