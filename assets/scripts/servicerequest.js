const displayColumns = [
    ...
    { key: 'clientserviceplan', label: 'clientserviceplan' },
    { key: 'requester', label: 'requester' },
    { key: 'prioritylevel', label: 'prioritylevel' },
    { key: 'title', label: 'title' },
    { key: 'description', label: 'description' },
    { key: 'desired_due_date', label: 'desired due date' },
];
...
function loadData() {
    ...
    var n_clientserviceplan = $('.search').find('[name=clientserviceplan]').val();
    var n_requester = $('.search').find('[name=requester]').val();
    var n_prioritylevel = $('.search').find('[name=prioritylevel]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-servicerequest-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            clientserviceplan: n_clientserviceplan,
            requester: n_requester,
            prioritylevel: n_prioritylevel
        },
