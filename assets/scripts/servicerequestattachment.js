const displayColumns = [
    ...
    { key: 'messagevisibility', label: 'messagevisibility' },
];
...
function loadData() {
    ...
    var n_messagevisibility = $('.search').find('[name=messagevisibility]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-servicerequestattachment-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            messagevisibility: n_messagevisibility
        },
