const displayColumns = [
    { key: 'user', label: 'user' },
    { key: 'profiletype', label: 'profiletype' },
    { key: 'profilestatus', label: 'profilestatus' },
    { key: 'display_title', label: 'display title' },
    { key: 'is_default', label: 'is default' },
    { key: 'request_notes', label: 'request notes' },
...
function loadData() {
    ...
    var n_profiletype = $('.search').find('[name=profiletype]').val();
    var n_profilestatus = $('.search').find('[name=profilestatus]').val();
    var n_reviewed_by = $('.search').find('[name=reviewed_by]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-userprofile-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            page_size: ps,
            user: n_user,
            profiletype: n_profiletype,
            profilestatus: n_profilestatus,
