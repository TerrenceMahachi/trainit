const displayColumns = [
    ...
    { key: 'rate_currency', label: 'rate currency' },
    { key: 'hourly_rate_snapshot', label: 'hourly rate snapshot' },
...
function loadData() {
    ...
    var n_assigned_role = $('.search').find('[name=assigned_role]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-workassignment-records";
