const displayColumns = [
    ...
    { key: 'assignmentstatus', label: 'assignmentstatus' },
...
function loadData() {
    ...
    var n_assignmentstatus = $('.search').find('[name=assignmentstatus]').val();

    const search = $('input[name="search"]').val();
    const ps = pageState.get('page_size', '10');
    const ob = $('#order_filter').val();
    var uri = site + "/get-workassignmentstatus-records";
    ...
    $.ajax({
        ...
        data: {
            ...
            assignmentstatus: n_assignmentstatus
        },
