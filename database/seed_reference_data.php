 ...
 * then populates lookup tables with standardized categories.
 */
...
new Engagementbasis();
new Engagementmodel();
new Worklocationpreference();
new Invoiceentitytype();
new Refereecontacttiming();
new Refereeverificationstatus();
new Vettingrecommendation();

// Domain models
new Rosterapplication();
new Apprenticeprofile();
new Associateprofile();
new Rosterskill();
new Rosterqualification();
new Rosterworkhistory();
new Rosterreferee();
new Rosterjudgementresponse();
new Rosterassessment();
new Rosteronboarding();
...
// Migrate rosterassessment table to ensure reviewer is nullable
...
function seedTable(PDO $pdo, string $tableName, array $columns, array $rows) {
...
// 1. ApplicationTrack
seedTable($pdo, 'applicationtrack', ['iD', 'code', 'name', 'description'], [
...
// 2. ApplicationStatus
seedTable($pdo, 'applicationstatus', ['iD', 'code', 'name', 'description', 'sort_order'], [
...
// 3. ServiceFunction (12 Functions)
seedTable($pdo, 'servicefunction', ['iD', 'code', 'name', 'description', 'sort_order'], [
...
// 4. ProficiencyLevel (1-5 Anchored Scale)
seedTable($pdo, 'proficiencylevel', ['iD', 'level_number', 'code', 'name', 'definition'], [
...
// 5. SkillItem (Granular skills for each of the 12 functions)
$skillsData = [
    // Finance (1)
...
seedTable($pdo, 'skillitem', ['iD', 'servicefunction', 'code', 'name', 'sort_order'], $skillRows);

// 6. ZimProvince
seedTable($pdo, 'zimprovince', ['iD', 'code', 'name', 'sort_order'], [
    [1, 'harare', 'Harare', 10],
...
// 7. WorkRightStatus
seedTable($pdo, 'workrightstatus', ['iD', 'code', 'name', 'description'], [
...
// 8. ApprenticeStatus
seedTable($pdo, 'apprenticestatus', ['iD', 'code', 'name', 'description'], [
...
// 9. EmploymentStatus
seedTable($pdo, 'employmentstatus', ['iD', 'code', 'name', 'description'], [
...
seedTable($pdo, 'qualificationtype', ['iD', 'code', 'name', 'sort_order'], [
...
// 11. QualificationStatus
seedTable($pdo, 'qualificationstatus', ['iD', 'code', 'name'], [
...
// 12. ProfessionalBody
seedTable($pdo, 'professionalbody', ['iD', 'code', 'name', 'description'], [
...
// 13. SectorType
seedTable($pdo, 'sectortype', ['iD', 'code', 'name'], [
...
// 14. EngagementBasis
seedTable($pdo, 'engagementbasis', ['iD', 'code', 'name'], [
...
// 15. EngagementModel
seedTable($pdo, 'engagementmodel', ['iD', 'code', 'name', 'description'], [
...
// 16. WorkLocationPreference
seedTable($pdo, 'worklocationpreference', ['iD', 'code', 'name'], [
...
// 17. InvoiceEntityType
seedTable($pdo, 'invoiceentitytype', ['iD', 'code', 'name'], [
...
// 18. RefereeContactTiming
seedTable($pdo, 'refereecontacttiming', ['iD', 'code', 'name'], [
...
// 19. RefereeVerificationStatus
seedTable($pdo, 'refereeverificationstatus', ['iD', 'code', 'name'], [
...
// 20. VettingRecommendation
seedTable($pdo, 'vettingrecommendation', ['iD', 'code', 'name', 'description'], [
