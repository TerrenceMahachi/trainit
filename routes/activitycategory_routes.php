...
use App\Controllers\ActivitycategorysController;
use App\Helpers\ViewAccess;
use App\Models\Activitycategory;

$uri = 'activitycategorys';
$table = 'activitycategory';
$options['view'] = 'activitycategorys';
$options['title'] = 'Activitycategory';
$options['MainController'] = new ActivitycategorysController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Activitycategory::where('iD', $recordiD);
    if (count($records) === 0) {
