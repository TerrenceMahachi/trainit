...
use App\Controllers\ApplicationstatussController;
use App\Helpers\ViewAccess;
use App\Models\Applicationstatus;

$uri = 'applicationstatuss';
$table = 'applicationstatus';
$options['view'] = 'applicationstatuss';
$options['title'] = 'Applicationstatus';
$options['MainController'] = new ApplicationstatussController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Applicationstatus::where('iD', $recordiD);
    if (count($records) === 0) {
