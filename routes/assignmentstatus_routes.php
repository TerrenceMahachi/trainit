...
use App\Controllers\AssignmentstatussController;
use App\Helpers\ViewAccess;
use App\Models\Assignmentstatus;

$uri = 'assignmentstatuss';
$table = 'assignmentstatus';
$options['view'] = 'assignmentstatuss';
$options['title'] = 'Assignmentstatus';
$options['MainController'] = new AssignmentstatussController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Assignmentstatus::where('iD', $recordiD);
    if (count($records) === 0) {
