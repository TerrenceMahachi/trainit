...
use App\Controllers\EmploymentstatussController;
use App\Helpers\ViewAccess;
use App\Models\Employmentstatus;

$uri = 'employmentstatuss';
$table = 'employmentstatus';
$options['view'] = 'employmentstatuss';
$options['title'] = 'Employmentstatus';
$options['MainController'] = new EmploymentstatussController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Employmentstatus::where('iD', $recordiD);
    if (count($records) === 0) {
