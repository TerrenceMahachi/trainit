...
use App\Controllers\LeavestatussController;
use App\Helpers\ViewAccess;
use App\Models\Leavestatus;

$uri = 'leavestatuss';
$table = 'leavestatus';
$options['view'] = 'leavestatuss';
$options['title'] = 'Leavestatus';
$options['MainController'] = new LeavestatussController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Leavestatus::where('iD', $recordiD);
    if (count($records) === 0) {
