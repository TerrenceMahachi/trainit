...
use App\Controllers\LeavetypesController;
use App\Helpers\ViewAccess;
use App\Models\Leavetype;

$uri = 'leavetypes';
$table = 'leavetype';
$options['view'] = 'leavetypes';
$options['title'] = 'Leavetype';
$options['MainController'] = new LeavetypesController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Leavetype::where('iD', $recordiD);
    if (count($records) === 0) {
