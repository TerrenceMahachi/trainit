...
use App\Controllers\PayslipdisbursementsController;
use App\Helpers\ViewAccess;
use App\Models\Payslipdisbursement;

$uri = 'payslipdisbursements';
$table = 'payslipdisbursement';
$options['view'] = 'payslipdisbursements';
$options['title'] = 'Payslipdisbursement';
$options['MainController'] = new PayslipdisbursementsController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Payslipdisbursement::where('iD', $recordiD);
    if (count($records) === 0) {
