...
use App\Controllers\PrioritylevelsController;
use App\Helpers\ViewAccess;
use App\Models\Prioritylevel;

$uri = 'prioritylevels';
$table = 'prioritylevel';
$options['view'] = 'prioritylevels';
$options['title'] = 'Prioritylevel';
$options['MainController'] = new PrioritylevelsController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Prioritylevel::where('iD', $recordiD);
    if (count($records) === 0) {
