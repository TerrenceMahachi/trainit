...
use App\Controllers\ProfiletypesController;
use App\Helpers\ViewAccess;
use App\Models\Profiletype;

$uri = 'profiletypes';
$table = 'profiletype';
$options['view'] = 'profiletypes';
$options['title'] = 'Profiletype';
$options['MainController'] = new ProfiletypesController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Profiletype::where('iD', $recordiD);
    if (count($records) === 0) {
