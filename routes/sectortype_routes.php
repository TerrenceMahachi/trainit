...
use App\Controllers\SectortypesController;
use App\Helpers\ViewAccess;
use App\Models\Sectortype;

$uri = 'sectortypes';
$table = 'sectortype';
$options['view'] = 'sectortypes';
$options['title'] = 'Sectortype';
$options['MainController'] = new SectortypesController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Sectortype::where('iD', $recordiD);
    if (count($records) === 0) {
