...
use App\Controllers\ServicecategorysController;
use App\Helpers\ViewAccess;
use App\Models\Servicecategory;

$uri = 'servicecategorys';
$table = 'servicecategory';
$options['view'] = 'servicecategorys';
$options['title'] = 'Servicecategory';
$options['MainController'] = new ServicecategorysController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Servicecategory::where('iD', $recordiD);
    if (count($records) === 0) {
