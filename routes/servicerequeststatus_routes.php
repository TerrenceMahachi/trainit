...
use App\Controllers\ServicerequeststatussController;
use App\Helpers\ViewAccess;
use App\Models\Servicerequeststatus;

$uri = 'servicerequeststatuss';
$table = 'servicerequeststatus';
$options['view'] = 'servicerequeststatuss';
$options['title'] = 'Servicerequeststatus';
$options['MainController'] = new ServicerequeststatussController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Servicerequeststatus::where('iD', $recordiD);
    if (count($records) === 0) {
