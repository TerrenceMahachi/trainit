...
use App\Controllers\SkillitemsController;
use App\Helpers\ViewAccess;
use App\Models\Skillitem;

$uri = 'skillitems';
$table = 'skillitem';
$options['view'] = 'skillitems';
$options['title'] = 'Skillitem';
$options['MainController'] = new SkillitemsController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Skillitem::where('iD', $recordiD);
    if (count($records) === 0) {
