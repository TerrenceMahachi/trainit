...
use App\Controllers\StaffdocumentsController;
use App\Helpers\ViewAccess;
use App\Models\Staffdocument;

$uri = 'staffdocuments';
$table = 'staffdocument';
$options['view'] = 'staffdocuments';
$options['title'] = 'Staffdocument';
$options['MainController'] = new StaffdocumentsController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Staffdocument::where('iD', $recordiD);
    if (count($records) === 0) {
