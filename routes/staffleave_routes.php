...
use App\Controllers\StaffleavesController;
use App\Helpers\ViewAccess;
use App\Models\Staffleave;

$uri = 'staffleaves';
$table = 'staffleave';
$options['view'] = 'staffleaves';
$options['title'] = 'Staffleave';
$options['MainController'] = new StaffleavesController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Staffleave::where('iD', $recordiD);
    if (count($records) === 0) {
