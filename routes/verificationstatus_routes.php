...
use App\Controllers\VerificationstatussController;
use App\Helpers\ViewAccess;
use App\Models\Verificationstatus;

$uri = 'verificationstatuss';
$table = 'verificationstatus';
$options['view'] = 'verificationstatuss';
$options['title'] = 'Verificationstatus';
$options['MainController'] = new VerificationstatussController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Verificationstatus::where('iD', $recordiD);
    if (count($records) === 0) {
