...
use App\Controllers\ZimprovincesController;
use App\Helpers\ViewAccess;
use App\Models\Zimprovince;

$uri = 'zimprovinces';
$table = 'zimprovince';
$options['view'] = 'zimprovinces';
$options['title'] = 'Zimprovince';
$options['MainController'] = new ZimprovincesController();

/** Fetch a record by id or render the 404 page (used by view/edit routes). */
$options['findOr404'] = function ($recordiD) use ($options) {
    $records = Zimprovince::where('iD', $recordiD);
    if (count($records) === 0) {
