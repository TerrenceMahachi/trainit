        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Workassignment</th>
                        <td class="text-muted"><?= htmlspecialchars($item->workassignment()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Supervisor_user</th>
                        <td class="text-muted"><?= htmlspecialchars($item->supervisor_user()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Supervision_notes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->supervision_notes ?? ''); ?></td>
                    </tr>
                        <tr>
