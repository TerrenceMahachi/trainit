        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="create_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="trading_name" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> registration_number: </label>
                    <input type="text" name="registration_number" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="billing_email" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="primary_phone" class="form-control form-control-lg" />
                </div>
                </div>
