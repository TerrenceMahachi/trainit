        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="plan_name" class="form-control form-control-lg" value="<?= htmlspecialchars($item->plan_name ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> currency: </label>
                    <input type="text" name="currency" class="form-control form-control-lg" value="<?= htmlspecialchars($item->currency ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> monthly_fee: </label>
                    <input type="number" name="monthly_fee" class="form-control form-control-lg" value="<?= htmlspecialchars($item->monthly_fee ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> included_hours: </label>
                    <input type="number" name="included_hours" class="form-control form-control-lg" value="<?= htmlspecialchars($item->included_hours ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> associate_rate: </label>
                    <input type="number" name="associate_rate" class="form-control form-control-lg" value="<?= htmlspecialchars($item->associate_rate ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> apprentice_rate: </label>
                    <input type="number" name="apprentice_rate" class="form-control form-control-lg" value="<?= htmlspecialchars($item->apprentice_rate ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> billing_cycle_day: </label>
                    <input type="number" name="billing_cycle_day" class="form-control form-control-lg" value="<?= htmlspecialchars($item->billing_cycle_day ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="service_manager" required>
                        ...
                        <?php foreach (User::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->service_manager == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="billing_owner" required>
                        ...
                        <?php foreach (User::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->billing_owner == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="excesspolicy" required>
                        ...
                        <?php foreach (Excesspolicy::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->excesspolicy == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group col-md-12 mb-4">
