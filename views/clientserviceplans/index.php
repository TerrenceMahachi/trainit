        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="row mt-3 search align-items-center g-2">
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='clientorganization'>
                        <option value="">All Clientorganizations</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='serviceoffering'>
                        <option value="">All Serviceofferings</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='service_manager'>
                        <option value="">All Service_managers</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='billing_owner'>
                        <option value="">All Billing_owners</option>
                        <?php foreach (User::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>"><?= $selector->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='excesspolicy'>
                        <option value="">All Excesspolicys</option>
