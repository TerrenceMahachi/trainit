        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Staffdocument</th>
                        <td class="text-muted"><?= htmlspecialchars($item->staffdocument()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Issue_date</th>
                        <td class="text-muted"><?= htmlspecialchars($item->issue_date ?? ''); ?></td>
                    </tr>
                    <tr>
