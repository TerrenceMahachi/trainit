    ...
    <section class="py-4">
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> is_paid: </label>
                    <input type="text" name="is_paid" class="form-control form-control-lg" value="<?= htmlspecialchars($item->is_paid ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> annual_days: </label>
                    <input type="number" name="annual_days" class="form-control form-control-lg" value="<?= htmlspecialchars($item->annual_days ?? '', ENT_QUOTES) ?>" />
                </div>
