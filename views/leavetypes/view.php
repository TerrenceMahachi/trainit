        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Is_paid</th>
                        <td class="text-muted"><?= htmlspecialchars($item->is_paid ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Annual_days</th>
                        <td class="text-muted"><?= htmlspecialchars($item->annual_days ?? ''); ?></td>
                    </tr>
                        <tr>
