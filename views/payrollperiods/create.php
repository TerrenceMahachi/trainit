        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="create_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> period_code: </label>
                    <input type="text" name="period_code" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> period_name: </label>
                    <input type="text" name="period_name" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> pay_date: </label>
                    <input type="date" name="pay_date" class="form-control form-control-lg" />
                </div>
                </div>
