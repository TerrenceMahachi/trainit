        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="period_code" class="form-control form-control-lg" value="<?= htmlspecialchars($item->period_code ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> period_name: </label>
                    <input type="text" name="period_name" class="form-control form-control-lg" value="<?= htmlspecialchars($item->period_name ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="date" name="pay_date" class="form-control form-control-lg" value="<?= htmlspecialchars($item->pay_date ?? '', ENT_QUOTES) ?>" />
                </div>
