        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Period_code</th>
                        <td class="text-muted"><?= htmlspecialchars($item->period_code ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Period_name</th>
                        <td class="text-muted"><?= htmlspecialchars($item->period_name ?? ''); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="fw-bold">Pay_date</th>
                        <td class="text-muted"><?= htmlspecialchars($item->pay_date ?? ''); ?></td>
                    </tr>
                        <tr>
