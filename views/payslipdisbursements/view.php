        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Payment_method</th>
                        <td class="text-muted"><?= htmlspecialchars($item->payment_method ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Transaction_reference</th>
                        <td class="text-muted"><?= htmlspecialchars($item->transaction_reference ?? ''); ?></td>
                    </tr>
                        <tr>
