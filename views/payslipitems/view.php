        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Payslip</th>
                        <td class="text-muted"><?= htmlspecialchars($item->payslip()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Payrollitemtype</th>
                        <td class="text-muted"><?= htmlspecialchars($item->payrollitemtype()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Item_name</th>
                        <td class="text-muted"><?= htmlspecialchars($item->item_name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Amount</th>
                        <td class="text-muted"><?= htmlspecialchars($item->amount ?? ''); ?></td>
                    </tr>
                        <tr>
