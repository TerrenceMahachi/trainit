    ...
    <section class="py-4">
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> gross_pay: </label>
                    <input type="number" name="gross_pay" class="form-control form-control-lg" value="<?= htmlspecialchars($item->gross_pay ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> total_deductions: </label>
                    <input type="number" name="total_deductions" class="form-control form-control-lg" value="<?= htmlspecialchars($item->total_deductions ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> net_pay: </label>
                    <input type="number" name="net_pay" class="form-control form-control-lg" value="<?= htmlspecialchars($item->net_pay ?? '', ENT_QUOTES) ?>" />
                </div>
