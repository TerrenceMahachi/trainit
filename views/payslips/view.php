        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Staffprofile</th>
                        <td class="text-muted"><?= htmlspecialchars($item->staffprofile()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="fw-bold">Gross_pay</th>
                        <td class="text-muted"><?= htmlspecialchars($item->gross_pay ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Total_deductions</th>
                        <td class="text-muted"><?= htmlspecialchars($item->total_deductions ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Net_pay</th>
                        <td class="text-muted"><?= htmlspecialchars($item->net_pay ?? ''); ?></td>
                    </tr>
                        <tr>
