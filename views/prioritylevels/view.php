        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Response_minutes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->response_minutes ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Resolution_hours</th>
                        <td class="text-muted"><?= htmlspecialchars($item->resolution_hours ?? ''); ?></td>
                    </tr>
                        <tr>
