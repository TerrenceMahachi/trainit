        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Level_number</th>
                        <td class="text-muted"><?= htmlspecialchars($item->level_number ?? ''); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="fw-bold">Definition</th>
                        <td class="text-muted"><?= htmlspecialchars($item->definition ?? ''); ?></td>
                    </tr>
                        <tr>
