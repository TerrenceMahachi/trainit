        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="row mt-3 search align-items-center g-2">
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='userprofile'>
                        <option value="">All Userprofiles</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='from_status'>
                        <option value="">All From_statuss</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='to_status'>
                        <option value="">All To_statuss</option>
                        <?php foreach (Profilestatus::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>"><?= $selector->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='performed_by'>
                        <option value="">All Performed_bys</option>
