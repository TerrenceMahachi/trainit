        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Userprofile</th>
                        <td class="text-muted"><?= htmlspecialchars($item->userprofile()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Action</th>
                        <td class="text-muted"><?= htmlspecialchars($item->action ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">From_status</th>
                        <td class="text-muted"><?= htmlspecialchars($item->from_status()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">To_status</th>
                        <td class="text-muted"><?= htmlspecialchars($item->to_status()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Performed_by</th>
                        <td class="text-muted"><?= htmlspecialchars($item->performed_by()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Notes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->notes ?? ''); ?></td>
                    </tr>
                        <tr>
