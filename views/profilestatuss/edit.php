    ...
    <section class="py-4">
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> badge_class: </label>
                    <input type="text" name="badge_class" class="form-control form-control-lg" value="<?= htmlspecialchars($item->badge_class ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> can_access_portal: </label>
                    <input type="text" name="can_access_portal" class="form-control form-control-lg" value="<?= htmlspecialchars($item->can_access_portal ?? '', ENT_QUOTES) ?>" />
                </div>
