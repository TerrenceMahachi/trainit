        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Badge_class</th>
                        <td class="text-muted"><?= htmlspecialchars($item->badge_class ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Can_access_portal</th>
                        <td class="text-muted"><?= htmlspecialchars($item->can_access_portal ?? ''); ?></td>
                    </tr>
                        <tr>
