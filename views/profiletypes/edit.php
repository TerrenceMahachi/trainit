    ...
    <section class="py-4">
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> icon: </label>
                    <input type="text" name="icon" class="form-control form-control-lg" value="<?= htmlspecialchars($item->icon ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> requires_approval: </label>
                    <input type="text" name="requires_approval" class="form-control form-control-lg" value="<?= htmlspecialchars($item->requires_approval ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> sort_order: </label>
                    <input type="number" name="sort_order" class="form-control form-control-lg" value="<?= htmlspecialchars($item->sort_order ?? '', ENT_QUOTES) ?>" />
                </div>
