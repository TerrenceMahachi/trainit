            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        ...
                        <td class="text-muted"><?= htmlspecialchars($item->code ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Name</th>
                        <td class="text-muted"><?= htmlspecialchars($item->name ?? ''); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="fw-bold">Icon</th>
                        <td class="text-muted"><?= htmlspecialchars($item->icon ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Requires_approval</th>
                        <td class="text-muted"><?= htmlspecialchars($item->requires_approval ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Sort_order</th>
                        <td class="text-muted"><?= htmlspecialchars($item->sort_order ?? ''); ?></td>
                    </tr>
                        <tr>
