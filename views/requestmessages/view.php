        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Messagevisibility</th>
                        <td class="text-muted"><?= htmlspecialchars($item->messagevisibility()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Body</th>
                        <td class="text-muted"><?= htmlspecialchars($item->body ?? ''); ?></td>
                    </tr>
                        <tr>
