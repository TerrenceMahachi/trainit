    ...
    <section id="records" class="py-4">
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="row mt-3 search align-items-center g-2">
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='applicationtrack'>
                        <option value="">All Applicationtracks</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='applicationstatus'>
                        <option value="">All Applicationstatuss</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='primaryfunction'>
                        <option value="">All Primaryfunctions</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='gender'>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='zimprovince'>
                        <option value="">All Zimprovinces</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='workrightstatus'>
                        <option value="">All Workrightstatuss</option>
