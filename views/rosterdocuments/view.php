        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Documenttype</th>
                        <td class="text-muted"><?= htmlspecialchars($item->documenttype()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="fw-bold">Original_name</th>
                        <td class="text-muted"><?= htmlspecialchars($item->original_name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">File_size_kb</th>
                        <td class="text-muted"><?= htmlspecialchars($item->file_size_kb ?? ''); ?></td>
                    </tr>
                        <tr>
