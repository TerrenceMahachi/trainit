        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="qualificationtype" required>
                        ...
                        <?php foreach (Qualificationtype::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->qualificationtype == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="professionalbody" required>
                        ...
                        <?php foreach (Professionalbody::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->professionalbody == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="qualificationstatus" required>
                        ...
                        <?php foreach (Qualificationstatus::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->qualificationstatus == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="field_of_study" class="form-control form-control-lg" value="<?= htmlspecialchars($item->field_of_study ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> date_obtained: </label>
                    <input type="date" name="date_obtained" class="form-control form-control-lg" value="<?= htmlspecialchars($item->date_obtained ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> expiry_date: </label>
                    <input type="date" name="expiry_date" class="form-control form-control-lg" value="<?= htmlspecialchars($item->expiry_date ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> certificate_doc: </label>
                    <input type="text" name="certificate_doc" class="form-control form-control-lg" value="<?= htmlspecialchars($item->certificate_doc ?? '', ENT_QUOTES) ?>" />
                </div>
