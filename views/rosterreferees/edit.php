        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="refereecontacttiming" required>
                        ...
                        <?php foreach (Refereecontacttiming::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->refereecontacttiming == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group mb-4 col-md-12">
                    ...
                    <select class="form-select form-select-lg f-sel" name="refereeverificationstatus" required>
                        ...
                        <?php foreach (Refereeverificationstatus::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>" <?= $data['record']->refereeverificationstatus == $selector->iD ? 'selected' : ''; ?>><?= htmlspecialchars($selector->name ?? ''); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> referee_name: </label>
                    <input type="text" name="referee_name" class="form-control form-control-lg" value="<?= htmlspecialchars($item->referee_name ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> organization: </label>
                    <input type="text" name="organization" class="form-control form-control-lg" value="<?= htmlspecialchars($item->organization ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> position: </label>
                    <input type="text" name="position" class="form-control form-control-lg" value="<?= htmlspecialchars($item->position ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> relationship: </label>
                    <input type="text" name="relationship" class="form-control form-control-lg" value="<?= htmlspecialchars($item->relationship ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="phone" class="form-control form-control-lg" value="<?= htmlspecialchars($item->phone ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> verification_notes: </label>
                    <input type="text" name="verification_notes" class="form-control form-control-lg" value="<?= htmlspecialchars($item->verification_notes ?? '', ENT_QUOTES) ?>" />
                </div>
