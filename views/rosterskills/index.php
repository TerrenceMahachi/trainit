        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="row mt-3 search align-items-center g-2">
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='rosterapplication'>
                        <option value="">All Rosterapplications</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='servicefunction'>
                        <option value="">All Servicefunctions</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='skillitem'>
                        <option value="">All Skillitems</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='proficiencylevel'>
                        <option value="">All Proficiencylevels</option>
