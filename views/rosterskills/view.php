        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Servicefunction</th>
                        <td class="text-muted"><?= htmlspecialchars($item->servicefunction()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Skillitem</th>
                        <td class="text-muted"><?= htmlspecialchars($item->skillitem()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Proficiencylevel</th>
                        <td class="text-muted"><?= htmlspecialchars($item->proficiencylevel()->name ?? ''); ?></td>
                    </tr>
                        <tr>
