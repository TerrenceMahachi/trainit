        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="create_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="position_title" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="is_current" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> key_deliverables: </label>
                    <input type="text" name="key_deliverables" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> reason_for_leaving: </label>
                    <input type="text" name="reason_for_leaving" class="form-control form-control-lg" />
                </div>
                </div>
