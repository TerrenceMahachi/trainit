        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="create_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    ...
                    <input type="text" name="file_path" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> file_name: </label>
                    <input type="text" name="file_name" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> file_size: </label>
                    <input type="number" name="file_size" class="form-control form-control-lg" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> mime_type: </label>
                    <input type="text" name="mime_type" class="form-control form-control-lg" />
                </div>
                <div class="form-group mb-4 col-md-12">
