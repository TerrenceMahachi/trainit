        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Closure_notes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->closure_notes ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Satisfaction_rating</th>
                        <td class="text-muted"><?= htmlspecialchars($item->satisfaction_rating ?? ''); ?></td>
                    </tr>
                        <tr>
