        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> sla_due_date: </label>
                    <input type="datetime-local" name="sla_due_date" class="form-control form-control-lg" value="<?= htmlspecialchars($item->sla_due_date ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> triage_notes: </label>
                    <input type="text" name="triage_notes" class="form-control form-control-lg" value="<?= htmlspecialchars($item->triage_notes ?? '', ENT_QUOTES) ?>" />
                </div>
