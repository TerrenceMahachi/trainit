        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Sla_due_date</th>
                        <td class="text-muted"><?= htmlspecialchars($item->sla_due_date ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Triage_notes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->triage_notes ?? ''); ?></td>
                    </tr>
                        <tr>
