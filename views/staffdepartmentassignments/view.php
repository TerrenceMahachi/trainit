            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        ...
                        <td class="text-muted"><?= htmlspecialchars($item->department()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Is_head</th>
                        <td class="text-muted"><?= htmlspecialchars($item->is_head ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Effective_from</th>
                        <td class="text-muted"><?= htmlspecialchars($item->effective_from ?? ''); ?></td>
                    </tr>
                        <tr>
