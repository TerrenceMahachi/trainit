        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Staffleave</th>
                        <td class="text-muted"><?= htmlspecialchars($item->staffleave()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Leavestatus</th>
                        <td class="text-muted"><?= htmlspecialchars($item->leavestatus()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Decision_notes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->decision_notes ?? ''); ?></td>
                    </tr>
                        <tr>
