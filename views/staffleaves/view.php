        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Leavetype</th>
                        <td class="text-muted"><?= htmlspecialchars($item->leavetype()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="fw-bold">Days_requested</th>
                        <td class="text-muted"><?= htmlspecialchars($item->days_requested ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Reason</th>
                        <td class="text-muted"><?= htmlspecialchars($item->reason ?? ''); ?></td>
                    </tr>
                        <tr>
