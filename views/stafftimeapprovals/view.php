        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Stafftimeentry</th>
                        <td class="text-muted"><?= htmlspecialchars($item->stafftimeentry()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Is_approved</th>
                        <td class="text-muted"><?= htmlspecialchars($item->is_approved ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Review_notes</th>
                        <td class="text-muted"><?= htmlspecialchars($item->review_notes ?? ''); ?></td>
                    </tr>
                        <tr>
