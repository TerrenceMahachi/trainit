        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Activitycategory</th>
                        <td class="text-muted"><?= htmlspecialchars($item->activitycategory()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Work_date</th>
                        <td class="text-muted"><?= htmlspecialchars($item->work_date ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Hours</th>
                        <td class="text-muted"><?= htmlspecialchars($item->hours ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Task_summary</th>
                        <td class="text-muted"><?= htmlspecialchars($item->task_summary ?? ''); ?></td>
                    </tr>
                        <tr>
