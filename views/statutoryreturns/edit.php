        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <form class="form py-3 m-md-3" id="update_item_form">
                ...
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> return_type: </label>
                    <input type="text" name="return_type" class="form-control form-control-lg" value="<?= htmlspecialchars($item->return_type ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> reference_number: </label>
                    <input type="text" name="reference_number" class="form-control form-control-lg" value="<?= htmlspecialchars($item->reference_number ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> total_contribution: </label>
                    <input type="number" name="total_contribution" class="form-control form-control-lg" value="<?= htmlspecialchars($item->total_contribution ?? '', ENT_QUOTES) ?>" />
                </div>
                <div class="form-group col-md-12 mb-4">
                    <label class="text-muted fw-lighter fs-6 mb-3 text-muted"> submission_date: </label>
                    <input type="date" name="submission_date" class="form-control form-control-lg" value="<?= htmlspecialchars($item->submission_date ?? '', ENT_QUOTES) ?>" />
                </div>
