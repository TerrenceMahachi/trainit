        ...
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="table-responsive py-3 m-md-3">
                <table class="table table-borderless align-middle detail-table">
                    ...
                    <tr>
                        <th class="fw-bold">Payrollperiod</th>
                        <td class="text-muted"><?= htmlspecialchars($item->payrollperiod()->name ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Return_type</th>
                        <td class="text-muted"><?= htmlspecialchars($item->return_type ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Reference_number</th>
                        <td class="text-muted"><?= htmlspecialchars($item->reference_number ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Total_contribution</th>
                        <td class="text-muted"><?= htmlspecialchars($item->total_contribution ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th class="fw-bold">Submission_date</th>
                        <td class="text-muted"><?= htmlspecialchars($item->submission_date ?? ''); ?></td>
                    </tr>
                        <tr>
