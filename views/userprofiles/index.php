    ...
    <section id="records" class="py-4">
        <div class="container rounded-4 p-4 bg-white shadow-sm">
            ...
            <div class="row mt-3 search align-items-center g-2">
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='profiletype'>
                        <option value="">All Profiletypes</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='profilestatus'>
                        <option value="">All Profilestatuss</option>
                ...
                <div class='mb-3 col-auto '>
                    <select class='form-select select save-state f-sel' name='reviewed_by'>
                        <option value="">All Reviewed_bys</option>
                        <?php foreach (User::all() as $selector): ?>
                            <option value="<?= $selector->iD; ?>"><?= $selector->name; ?></option>
                        <?php endforeach; ?>
                    </select>
